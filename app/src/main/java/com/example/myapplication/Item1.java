...
public class Item1 extends AppCompatActivity {
    Button button6, button8, pay,button10;
    ...
    boolean isPink,isYellow,isRed = false;
    boolean isSmall,isXsmall,isMedium = false;
...
//        recycler_view.setAdapter(mAdapter);
        ...
        Glide.with(Item1.this).load(uri).into(imageView);

        DatabaseReference redRef = FirebaseDatabase.getInstance().getReference().child("uploads").child("-LpJx7IJxFtRZfS6XuU1");
        ...
        button6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Item1.this,Cart.class);
                startActivity(intent);
