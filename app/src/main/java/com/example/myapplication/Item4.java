...
public class Item4 extends AppCompatActivity {
    Button button6, button8, pay,button14;
...
//        recycler_view.setAdapter(mAdapter);
        ...
        Glide.with(Item4.this).load(uri).into(imageView);
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Item4.this, payment.class);
        ...
        button6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Item4.this,Cart.class);
                startActivity(intent);
